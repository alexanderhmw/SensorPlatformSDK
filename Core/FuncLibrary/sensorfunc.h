...
extern "C" Q_DECL_EXPORT bool openSensor(void * params, QObject ** trigger, QString & triggersignal);	//open the sensor using params
extern "C" Q_DECL_EXPORT bool captureData(void * params, void ** data);	//capture data using params and store in data
extern "C" Q_DECL_EXPORT bool closeSensor(void * params, QObject ** trigger, QString & triggersignal);	//close the sensor using params
